...
/// Dark anime-themed colors with vibrant accents
class DarkModeColors {
  // Accent red used for primary actions and ratings
  static const darkPrimary = Color(0xFFE50914); // Netflix-like red
  static const darkOnPrimary = Color(0xFFFFFFFF);
  static const darkPrimaryContainer = Color(0xFF7F0A0F);
  static const darkOnPrimaryContainer = Color(0xFFFFE6E8);

  // Minimal supporting accents (kept muted)
  static const darkSecondary = Color(0xFF9AA0A6); // muted grey
  static const darkOnSecondary = Color(0xFF0A0A0A);

  static const darkTertiary = Color(0xFF8AB4F8); // subtle blue, rarely used
  ...
  // Surfaces: pure black / very dark gray
  static const darkSurface = Color(0xFF0A0A0A); // near black
  static const darkOnSurface = Color(0xFFECECEC);
  static const darkSurfaceVariant = Color(0xFF111214); // dark gray for panels
  static const darkOnSurfaceVariant = Color(0xFFB5B8BD);

  // Outline and shadow
  static const darkOutline = Color(0xFF2A2C30);
  static const darkShadow = Color(0xFF000000);
  static const darkInversePrimary = darkPrimary;
}
...
ThemeData get darkTheme => ThemeData(
  ...
  // Remove splash effects globally for a modern streaming feel
  ...
  outlinedButtonTheme: OutlinedButtonThemeData(
    style: ButtonStyle(
      side: WidgetStatePropertyAll(BorderSide(color: DarkModeColors.darkPrimary, width: 1.2)),
      foregroundColor: const WidgetStatePropertyAll(Colors.white),
